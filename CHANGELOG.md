...
- POC-04 Windows 11、Windows Server 2025 功能链 PASS：两端确定性场景均为 11/11，真实 DeepSeek 文本/流式/结构化/401 全部通过；Debian 13 为 `NOT_RUN`。
...
- POC-04 尚未在 Debian 13 执行或取得独立例外，当前保持 `IN_PROGRESS`。
