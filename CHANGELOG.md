...
- POC-03 新增 R4 待办清单严格导入器：复核锁定任务与候选来源，只将“同意 AI 建议”转为批准；“暂不处理”保持 PENDING，“修改后确认”必须补充结构化字段后才能导入。
...
- POC-03 更新后的 R4 含 1 条“同意 AI 建议”和 119 条“修改后确认”；后者只记录项目交接阶段的后续确认安排，严格导入仍为 1 条 APPROVED、119 条 PENDING、0 个问题。79/79 单元测试通过，未生成正式 Golden Dataset。
