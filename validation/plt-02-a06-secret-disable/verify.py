    ...
    with connect("postgres") as admin:
        ...
        try:
            ...
            try:
                ...
                disable_command = DisableSecret(b"s" * 32, b"c" * 32, ref, 1, uuid.uuid4())
                service.disable(disable_command)
                try:
                    service.disable(disable_command)
                ...
                print("PASS: disabled Secret hides ciphertext, retires active version, preserves audit and rejects stale repeat")
            finally:
                runtime.dispose()
        finally:
