...
|P03-A02|100~200 条人工确认 Golden Dataset|IN_PROGRESS|NOT_RUN|NOT_RUN|29 份四类来源文档生成 120 条候选并覆盖 29/29 文档。R4 用户结果为 1 条“同意 AI 建议”、119 条“暂不处理”；严格导入为 APPROVED 1、PENDING 119、问题 0，距最低 100 条批准还差 99 条，未写出正式 Golden Dataset|
