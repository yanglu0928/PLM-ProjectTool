param(
    [string]$OutputDirectory = "artifacts/poc-09/windows-server-2025"
)
...
$archivePath = Join-Path $outputRoot "poc-09-windows-server-bundle.zip"
...
$target = Join-Path $stageRoot "poc-09-license"
...
[ordered]@{
    schema_version = "poc09.bundle.v1"
