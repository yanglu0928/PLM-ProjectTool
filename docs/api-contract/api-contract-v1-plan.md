...
`IN_PROGRESS / API-01_PASS / API-02_PASS / API-03_NEXT / NOT_GATE_2_FROZEN / NO_FASTAPI_IMPLEMENTATION`
...
API-03：细化 AI/RAG/Job/Plugin/Output 的异步提交、外发授权、状态、取消、结果、SSE、错误和权限契约。
