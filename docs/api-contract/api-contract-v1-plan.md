...
`IN_PROGRESS / API-01_PASS / API-02_PASS / API-03_PASS / API-04_NEXT / NOT_GATE_2_FROZEN / NO_FASTAPI_IMPLEMENTATION`
...
API-04：细化 Capability/Handover/Survey/Requirement/Prototype/Solution/Plan 的版本、Review、正式化、Trace、AI 建议态、错误和权限契约。
