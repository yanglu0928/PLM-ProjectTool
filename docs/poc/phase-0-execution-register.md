...
|POC-03|P0.09/P0.10/P0.12|PLM RAG|BLOCKED|2026-09-17|-|R5 Golden 标签 120/120 已确认；P03-A11 经 OCR 规范化达到 114/120（95.00%）PASS。P03-A12 为 57.50%，P03-A13 在当前 Top-5 Context 下上限 95.00%，触发 L3 引用基线/验收口径决策|`poc/poc-03-plm-rag/`|
