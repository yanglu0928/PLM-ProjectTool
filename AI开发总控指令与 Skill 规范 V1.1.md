...
版本：V1.1  
变更日期：2026-09-17  
变更依据：用户明确确认新增 Windows 11，与 Windows Server 2025、Debian 13 并列支持。  
历史版本：V1.0 保留，不覆盖。

后续正式 License 专项变更：2026-09-24 用户明确批准 `CR-LIC-001` 方案 B。执行 License 任务时，《软件开发实施方案 V2.1》须连同 `PLM项目实施辅助工具软件开发实施方案 V2.1 License 变更补充 CR-LIC-001.md` 一并适用；其他原有规则不变。
...
> 严格依据已经正式锁定的《PLM项目实施辅助工具｜软件开发实施方案 V2.1》执行技术验证、架构设计、数据模型设计、接口设计、开发、测试、打包和部署工作。

《软件开发实施方案 V2.1》是本项目的最高业务与技术基线。
