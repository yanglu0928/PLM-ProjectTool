...
|Current WBS|`AUT-03-A05 登录 SessionView 真实身份投影`（已完成；PLT-02-A07 仍待前置）|
|Current Status|PHASE_1_COMPLETE / AUT_03_A05_PASS / PLT_02_A07_PREREQUISITES_IN_PROGRESS / PHASE_2_IN_PROGRESS|
...
|Completed WBS|POC-01、POC-02、POC-04、POC-05、POC-06、POC-08、POC-09 已按验证或批准例外收口；POC-03 以批准替代方案收口；Gate 1 已通过；AF-01～AF-05、DM-01～DM-06、SC-01～SC-05、API-01～API-05 PASS；Gate 2 已批准并冻结四份基线；1.01～1.09、PLT-01-A01～A03、PLT-02-A01～A06、AUD-01-A01～A03、AUT-01-A01～A03、AUT-02-A01～A05、AUT-03-A01～A05、LIC-01-A01～A04、LIC-02-A01～A05、LIC-03-A01～A03 PASS|
...
|DB Schema Version|`DB-SCHEMA-CANDIDATE-V1`；Gate 2 原冻结内容 `64cdf09`；Auth 登录限流表差异见 CR-AUT-001、Alembic `20260925_0012`|
|API Contract Version|`API-CONTRACT-CANDIDATE-V1`；API-01～API-05 PASS，Gate 2 已冻结（内容提交 `64cdf09`）|
|Test Summary|AUT-03-A05：Windows 11/Python 3.13 后端 229/229 PASS；PostgreSQL 18.6 User/角色/停用投影与 HTTP 失败无 Cookie PASS；wheel 构建 PASS。生产默认登录/Secret 路由仍 404|
|Next WBS|`AUT-03-A06 初始 DeploymentAdmin 受控创建与登录生产装配前置`；后续推进 Session HTTP、Project 授权摘要、生产 License/Key Provider 与幂等/If-Match，再恢复 PLT-02-A07|
