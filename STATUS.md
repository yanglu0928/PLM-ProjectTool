...
|Current WBS|`CR-DOC-008/A03-P03 生产停写/Server 2025 前置核查`（VM 可启动；正式停写、目标账户与恢复演练未满足）|
...
|Next WBS|CR-DOC-008/A03-P03 保持待目标账户/停写材料恢复；转不依赖生产信任源的独立 Phase 2 任务。POC-03 质量与 Release 容量仍待，Debian 13 暂不验证|
