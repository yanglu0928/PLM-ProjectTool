...
|Current WBS|`AUD-03-A06-A04-P03-A07-P04-P03-P06-P02 单命令执行器`（共享真实心跳/成功-终止-取消-retry及来源核验内部PASS；claim/主循环待）|
...
|Test Summary|P06-P02 Windows11/Python3.13后端1060项无失败（2既有环境跳过）；13新unit/真实bounded PG-Vault共享周期心跳两Scope0/260新导出/撤权安全终止且无capture/成功后撤权不改/活期-到期-render中取消/内容终止vs基础retry，四类真实commit后确认故障均来源核验/六表无写重放/裸取消拒绝；旧发布/wheel成功|
|Next WBS|AUD-03-A06-A04-P03-A07-P04-P03-P06-P03：Audit专属实际claim到命令适配；再主循环/CLI/提交Jobs HTTP。公开POST/If-Match仍待。网络/质量/Gate/正式材料/完整Scope保留，Server2025未验、Debian13暂缓|
