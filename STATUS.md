...
|Current WBS|`WFL-01-A02-P01 Workflow 状态及迁移结构`（枚举/相邻推进/版本与归档拒绝纯领域 PASS；不执行实际迁移）|
...
|Next WBS|WFL-01-A03-P01 ProjectWorkflow/Stage/Checklist 持久层与初始化不变量设计及 CR 前置检查；Trace HTTP 待各 Owner 受权解析，EVD-01-A03-P02-A02 待 Phase 3 Parser，发行 Gate/Server 2025 待验证，Debian 13 暂不验证|
