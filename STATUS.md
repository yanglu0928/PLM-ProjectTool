...
|Current WBS|`AUD-03-A06-A04-P03-A07-P04-P03-P04-P03 后台取消确认`（首申请来源/当前活代SYSTEM Audit同UOW PASS；到期恢复/接线/主循环待）|
...
|Test Summary|P04-P04-P03 Windows11/Python3.13后端1021项无失败（2既有环境跳过）；4新unit/实际PG-Vault两Scope首USER申请来源到SYSTEM取消完成原子、User+License撤权仍仅安全ack、首历史和字节保留，Audit/ack写后及后验identity故障回滚；错绑定/终态/首审计缺失/实际到期拒绝，旧发布/wheel成功|
|Next WBS|AUD-03-A06-A04-P03-A07-P04-P03-P04-P04：到期取消系统恢复；再取消确认丢失、瞬时retry/执行器/主循环/提交Jobs HTTP。公开POST/If-Match仍待。网络/质量/Gate/正式材料/完整Scope保留，Server2025未验、Debian13暂缓|
