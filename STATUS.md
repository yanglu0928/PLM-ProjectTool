...
|Current WBS|`DOC-03-A03-P02 FileObject 失败/限制状态事务命令`（隔离 PostgreSQL 合成授权已验证；未装配公开 API）|
|Current Status|PHASE_1_COMPLETE / DOC_03_A03_P02_INTERNAL_COMMAND_PASS / DOC_03_A03_PUBLICATION_PENDING / PLT_02_A07_P05_A09_CEREMONY_PENDING / PHASE_2_IN_PROGRESS|
...
|Completed WBS|POC-01、POC-02、POC-04、POC-05、POC-06、POC-08、POC-09 已按验证或批准例外收口；POC-03 以批准替代方案收口；Gate 1 已通过；AF-01～AF-05、DM-01～DM-06、SC-01～SC-05、API-01～API-05 PASS；Gate 2 已批准并冻结四份基线；1.01～1.09、PLT-01-A01～A03、PLT-02-A01～A06、API-RUNTIME-01（仅 Win11）、PRJ-03-A01～A04、AUD-01-A01～A03、AUT-01-A01～A03、AUT-02-A01～A05、AUT-03-A01～A06、AUT-03-A07-P01～P03（P02/P03 仅 Win11）、AUT-03-A08～A10（仅 Win11）、PRJ-01-A01～A06、PRJ-02-A01～A04、LIC-01-A01～A04、LIC-02-A01～A05、LIC-03-A01～A03、DOC-03-A01、DOC-03-A02（限定范围）、DOC-03-A03-P01～P02 PASS|
...
|DB Schema Version|`DB-SCHEMA-CANDIDATE-V1`；Gate 2 原冻结内容 `64cdf09`；Auth 限流增量 `20260925_0012`，PRJ-01～03 正式实现 Migration `20260925_0013`，成员变更历史增量 `20260925_0014`（CR-PRJ-001），通用幂等收据增量 `20260925_0015`（CR-API-001），成员首次响应快照增量 `20260925_0016`（CR-PRJ-002），成员状态首次响应快照增量 `20260925_0017`（CR-PRJ-003），部门创建首次响应快照增量 `20260925_0018`（CR-PRJ-004），部门停用首次响应快照增量 `20260925_0019`（CR-PRJ-005），FileObject 元数据与状态历史增量 `20260925_0020`（CR-DOC-001）|
|API Contract Version|`API-CONTRACT-CANDIDATE-V1`；API-01～API-05 PASS，Gate 2 已冻结（内容提交 `64cdf09`）|
|Test Summary|DOC-03-A03-P02：Windows 11/Python 3.13 后端 453 项无失败（2 项符号链接场景跳过）；PostgreSQL 18 临时库状态/事件/Audit/收据同事务、同键并发/重放、版本/Scope/合成授权拒绝、审计失败回滚/重试及开发 wheel PASS|
|Next WBS|DOC-01-A01 Document 持久层前置核查；DOC-03 的 AVAILABLE 发布、清理资格、正式授权与恢复器须在 DocumentVersion/文件证明就绪后继续；发行信任源仍待工作台操作员仪式，Server 2025/HTTPS 仍待；Debian 13 暂不验证|
