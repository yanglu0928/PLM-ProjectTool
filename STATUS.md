...
|Current WBS|`PRJ-04-A14-P01 Department 创建持久幂等前置`（隔离 PostgreSQL 已验证；公开 POST 未开放）|
|Current Status|PHASE_1_COMPLETE / PRJ_04_A14_P01_INTERNAL_IDEMPOTENCY_PASS / PLT_02_A07_P05_A09_CEREMONY_PENDING / PHASE_2_IN_PROGRESS|
...
|Test Summary|PRJ-04-A14-P01：Windows 11/Python 3.13 后端 431/431 PASS；PostgreSQL 18 临时库空/已有数据升级、ORM drift、同 Key 并发/历史快照/审计回滚/非空降级保护及开发 wheel PASS|
|Next WBS|PRJ-04-A14-P02 Department 创建可选 HTTP；PLT-02-A07-P05-A09 发行信任源待工作台操作员仪式，Server 2025/HTTPS 仍待；Debian 13 暂不验证|
