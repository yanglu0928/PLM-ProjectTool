...
|Current WBS|`EVD-01-A03-P02-A01 固定版本全文来源证明`（Windows 11 临时文件/回归 PASS；八类精确定位仍待）|
...
|Next WBS|EVD-01-A03-P02-A02 八类精确 Locator 的 Document 解析来源证明；之后 P03 同事务候选创建/幂等/Audit。CR-DOC-008/A03-P03 待目标账户/停写材料，Debian 13 暂不验证|
