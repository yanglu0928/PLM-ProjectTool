...
|Current WBS|`RVW-01-A06 Review identity 创建前置`（设计完成；真实 Owner 阻塞公开接线，转内部创建命令）|
...
|Next WBS|RVW-01-A07 内部 PM Review identity 创建/幂等与真实 Session/Project/Audit 验收；缺真实 Subject Owner 不挂载 HTTP，真实资格/Owner/受权审批命令、START/完成仍待，原 Scope 保留。Trace HTTP 待各 Owner 受权解析，EVD-01-A03-P02-A02 待 Phase 3 Parser，发行 Gate/Server 2025 待验证，Debian 13 暂不验证|
